...
public class SQLiteTool {
	...
	public final static String[] columns = { FIELD1, FIELD2, FIELD3, FIELD4,
	...
	public SQLiteTool() {
		...
		try {
			mDb.execSQL("create table if not exists " + TABLE_NAME + " ( "
					+ FIELD1 + " text not null, " + FIELD2 + " text not null,"
					+ FIELD3 + " text not null," + FIELD4 + " text not null,"
					+ FIELD5 + " text not null," + FIELD6 + " text not null,"
					+ FIELD7 + " text not null," + FIELD8 + " text not null,"
					+ FIELD9 + " text not null," + FIELD10 + " text not null,"
					+ FIELD11 + " text not null," + FIELD12 + " text not null,"
