...
/**
 * Created with IntelliJ IDEA. User: liulin Date: 13-5-14 Time: 上午11:58 To
...
public class RouteInfoListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listItemAdapter = new SimpleAdapter(this, listItem,
				R.layout.list_route_item, new String[] { "startname",
						"endname", "passengerphone", "timetext" }, new int[] {
						R.id.item_name, R.id.item_detail, R.id.item_distance,
						R.id.item_fee });
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Double startLon = Double
						.valueOf(map.get("startlon").toString());
				Double startLat = Double
						.valueOf(map.get("startlat").toString());
