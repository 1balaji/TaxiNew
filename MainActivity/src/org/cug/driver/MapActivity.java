...
public class MapActivity extends FragmentActivity implements
 ...
 // for receive customer msg from jpush server
    ...
    public void initStartPoint() {
        ...
        if (geoLat != null) {
            startMk = aMap.addMarker(new MarkerOptions().anchor(0.5f, 1)
                    ...
                    .position(new LatLng(geoLat, geoLng))
                    .title("所在位置"));
    ...
    public void searchRouteResult(LatLonPoint startPoint, LatLonPoint endPoint) {
        progDialog = ProgressDialog.show(MapActivity.this, null,
                "正在获取线路", true, true);
        ...
        public void handleMessage(Message msg) {
            if (msg.what == Constants.ROUTE_SEARCH_RESULT) {
                ...
                if (routeResult != null && routeResult.size() > 0) {
                    ...
                    if (route != null) {
                        routeOverlay = new RouteOverlay(MapActivity.this,
                                aMap, route);
        ...
        switch (requestCode) {
            ...
            case RoutePlan:
                if (data.hasExtra("startPointLon")) {
                    ...
                    LatLonPoint startPoi = new LatLonPoint(startPointLat, startPointLon);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case ITEM0:
                startActivity(new Intent(MapActivity.this, ShowMessageActivity.class));
                break;
            case ITEM1:
                //initStartPoint();
                ...
                break;
            case ITEM2:
                Intent intent3 = new Intent(MapActivity.this, RouteInfoListActivity.class);
